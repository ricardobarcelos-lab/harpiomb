    ...
    <section id="investimento" className="py-24 px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-xs text-muted-foreground text-center mt-6">
          <span className="text-primary font-semibold">*</span> Os valores demonstrados são líquidos de impostos
          e não consideram os impostos de <span className="font-semibold text-foreground">14,25%</span>. Valores
          referenciais. Faixa 8 (acima de R$ 35k) atendida sob demanda com escopo customizado.
        </p>
